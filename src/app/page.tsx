      ...
      <div className="max-w-2xl mx-auto space-y-20">
        ...
        <section>
          <div className="flex items-baseline justify-between mb-6">
            <p className="text-white/25 text-xs uppercase tracking-widest">Journal</p>
            <p className="text-white/18 text-xs">— Human created, Olin</p>
          </div>
          <blockquote className="text-white/70 text-sm leading-relaxed whitespace-pre-wrap">
            {JOURNAL}
          </blockquote>
        </section>
        ...
        <section>
          <div className="flex items-baseline justify-between mb-6">
            <p className="text-white/25 text-xs uppercase tracking-widest">Beliefs</p>
            <p className="text-white/18 text-xs">— Human created, Olin</p>
          </div>
        ...
        <section>
          <div className="flex items-baseline justify-between mb-6">
            <p className="text-white/25 text-xs uppercase tracking-widest">About</p>
